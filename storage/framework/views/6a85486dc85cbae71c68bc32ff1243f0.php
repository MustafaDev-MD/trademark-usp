...
<section class="blog-hero-section">
    <div class="blog-hero-wrapper">
        ...
        <nav class="blog-hero-breadcrumbs">
            <a href="<?php echo e(route('home')); ?>" class="blog-hero-breadcrumb-link">Home</a>
            <span class="blog-hero-separator">/</span>
            <a href="<?php echo e(route('blog')); ?>" class="blog-hero-breadcrumb-link">Blog</a>
            <span class="blog-hero-separator">/</span>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\trademark-usp\resources\views/blog-page5.blade.php ENDPATH**/ ?>