...
<?php $__env->startSection('title', 'Guarantee - Trademark USP'); ?>
        ...
        <aside class="legal-layout-sidebar">
            <div class="legal-layout-nav-fixed">
                ...
                <ul class="legal-layout-nav-list">
                    ...
                    <li><a href="<?php echo e(route('privacy-policy')); ?>" class="legal-layout-nav-link">Trademark USP Privacy Policy</a></li>
                    <li><a href="<?php echo e(route('guarantee')); ?>" class="legal-layout-nav-link">Trademark USP Guarantee</a></li>
                    <!-- <li><a href="#user-obligations" class="legal-layout-nav-link">User Obligations</a></li> -->
                    <li><a href="<?php echo e(route('term-of-service')); ?>" class="legal-layout-nav-link">Trademark USP Terms of Service</a></li>
                </ul>
            </div>
        </aside>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\trademark-usp\resources\views/guarantee.blade.php ENDPATH**/ ?>